...
plot '< cat ntmp_beffio_rewrite' using 3:5 title "scatter - type 0" with linespoints 1 1,\
     '< cat ntmp_beffio_rewrite' using 3:6 title "shared - type 1" with linespoints 2 2,\
     '< cat ntmp_beffio_rewrite' using 3:7 title "separate - type 2" with linespoints 3 3,\
     '< cat ntmp_beffio_rewrite' using 3:8 title "segment - type 3" with linespoints 4 4,\
     '< cat ntmp_beffio_rewrite' using 3:9 title "seg-coll - type 4" with linespoints 5 5
