\section{/home/aching/Avery/Work.School/Research/pvfs2-lock/s3asim/src/llist.h File Reference}
\label{llist_8h}\index{/home/aching/Avery/Work.School/Research/pvfs2-lock/s3asim/src/llist.h@{/home/aching/Avery/Work.School/Research/pvfs2-lock/s3asim/src/llist.h}}
...
\index{llist.h@{llist.h}!cpy_result@{cpy\_\-result}}
\index{cpy_result@{cpy\_\-result}!llist.h@{llist.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int cpy\_\-result (struct \bf{result\_\-s} $\ast$ {\em dest\_\-result\_\-p}, struct \bf{result\_\-s} $\ast$ {\em src\_\-result\_\-p})}\label{llist_8h_b0d6e6a78fceaae23acdbf75b6ad5344}
...
\index{llist.h@{llist.h}!create_list_head@{create\_\-list\_\-head}}
\index{create_list_head@{create\_\-list\_\-head}!llist.h@{llist.h}}
...
\index{llist.h@{llist.h}!delete_list_head@{delete\_\-list\_\-head}}
\index{delete_list_head@{delete\_\-list\_\-head}!llist.h@{llist.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}struct \bf{lresult\_\-s}$\ast$ delete\_\-list\_\-head (struct \bf{lresult\_\-s} $\ast$ {\em list\_\-head})}\label{llist_8h_7cb05d5f6c11bd2b8b7ff00c9167d5a7}
...
\index{llist.h@{llist.h}!free_lresult_list@{free\_\-lresult\_\-list}}
\index{free_lresult_list@{free\_\-lresult\_\-list}!llist.h@{llist.h}}
...
\end{Desc}
\index{llist.h@{llist.h}!merge_lresult@{merge\_\-lresult}}
\index{merge_lresult@{merge\_\-lresult}!llist.h@{llist.h}}
...
\index{llist.h@{llist.h}!print_lresult_list@{print\_\-lresult\_\-list}}
\index{print_lresult_list@{print\_\-lresult\_\-list}!llist.h@{llist.h}}
...
\end{Desc}
\index{llist.h@{llist.h}!push_list@{push\_\-list}}
\index{push_list@{push\_\-list}!llist.h@{llist.h}}
